...
namespace YirenReaderConsole
{
    ...
    public class ProgressBar
    {
        ...
        public double Dispaly(double value)
        {
            if (this.Valued != value)
            {
                this.Valued = value;
                ...
                if (this.ProgressBarType == ProgressBarType.Multicolor)
                {
                    ...
                    Console.Write(new string(' ', (int)Math.Round(this.Valued / (100.0 / this.Width))));
                    Console.BackgroundColor = colorBack;
                ...
                else
                {
                    ...
                    Console.Write(new string('*', (int)Math.Round(this.Valued / (100.0 / (this.Width - 2)))));
                    // 显示百分比   
                    Console.SetCursorPosition(this.Left + this.Width + 1, this.Top);
                }
            }
